...
class _TaskListPageState extends State<TaskListPage> {
  ...
  void _loadTasks() async {
    ...
    setState(() {
      _tasks = tasks;
      _completedDates = tasks.expand((task) => task.completionDates).toList();
    });
  }
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Expanded(
  child: Padding(
    padding: const EdgeInsets.only(bottom: 120.0), // Add 20px padding at the bottom
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: task.isCompleted
                          ? Colors.black
                          : const Color(0xFF9E7C6F), // Black border for completed tasks, brown for others
        ...
        children: [
          ...
          Expanded(
            child: TableCalendar(
              ...
              availableCalendarFormats: const {  // Only show the monthly view
                CalendarFormat.month: 'شهر', // "Month" in Arabic
              },
              calendarStyle: CalendarStyle(
                selectedDecoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: Colors.brown[300], // Light brown color for selected day
                ),
              ...
              calendarBuilders: CalendarBuilders(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          color: isCompleted
                              ? Colors.white
                              : Colors.black, // White text for completed days
                        ),
                      ),
                    ),
                  );
                ...
                todayBuilder: (context, day, focusedDay) {
                  return Container(
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 27, 23, 19), // Brown color for today's date
                      shape: BoxShape.circle, // Rounded corners
                    ),
                    margin: const EdgeInsets.all(
                        4.0), // Small margin around the day
